    ...
    return (
      ...
      >
        ...
        <g clipPath={`url(#clip-path-${clipPath.id})`}>
          {!canvasUserLayer && (
            <g onClick={() => this.handOnClickEmptyImage(index)}>
              ...
              <svg
                ...
                height="96"
                viewBox="0 0 128 96"
                x={clipPath.width / 2 - 128 / 2}
                y={clipPath.height / 2 - 96 / 2}
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
          ...
          {canvasUserLayer && (
            <svg
              width={canvasUserLayer.width}
              height={canvasUserLayer.height}
              x="0"
              y="0"
              viewBox={`0 0 ${canvasUserLayer.width} ${canvasUserLayer.height}`}
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
              overflow="visible"
            >
              <g
                transform={`rotate(0, ${canvasUserLayer.width / 2}, ${
                  canvasUserLayer.height / 2
                })`}
              >
                <image
                  xlinkHref={canvasUserLayer.dataUrl}
                  width="100%"
                  height="100%"
                />
              </g>
